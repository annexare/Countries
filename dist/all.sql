...
INSERT INTO `languages` (`code`, `name`, `native`, `rtl`) VALUES
  ...
  ('bn', 'Bengali', 'বাংলা', '0'),
  ('bo', 'Tibetan', 'བོད་ཡིག / Bod skad', '0'),
  ('br', 'Breton', 'Brezhoneg', '0'),
  ('bs', 'Bosnian', 'Bosanski', '0'),
  ('ca', 'Catalan', 'Català', '0'),
  ('ce', 'Chechen', 'Нохчийн', '0'),
  ('ch', 'Chamorro', 'Chamoru', '0'),
  ('co', 'Corsican', 'Corsu', '0'),
  ('cr', 'Cree', 'Nehiyaw', '0'),
  ('cs', 'Czech', 'Česky', '0'),
  ('cu', 'Old Church Slavonic / Old Bulgarian', 'словѣньскъ / slověnĭskŭ', '0'),
  ('cv', 'Chuvash', 'Чăваш', '0'),
  ('cy', 'Welsh', 'Cymraeg', '0'),
  ('da', 'Danish', 'Dansk', '0'),
  ('de', 'German', 'Deutsch', '0'),
  ...
  ('nv', 'Navajo', 'Diné bizaad', '0'),
  ('ny', 'Chichewa', 'Chi-Chewa', '0'),
  ('oc', 'Occitan', 'Occitan', '0'),
  ('oj', 'Ojibwa', 'ᐊᓂᔑᓈᐯᒧᐎᓐ / Anishinaabemowin', '0'),
  ('om', 'Oromo', 'Oromoo', '0'),
  ('or', 'Oriya', 'ଓଡ଼ିଆ', '0'),
  ('os', 'Ossetian / Ossetic', 'Иронау', '0'),
  ...
  ('sd', 'Sindhi', 'सिनधि', '0'),
  ('se', 'Northern Sami', 'Sámegiella', '0'),
  ('sg', 'Sango', 'Sängö', '0'),
  ('sh', 'Serbo-Croatian', 'Srpskohrvatski / Српскохрватски', '0'),
  ...
  ('tt', 'Tatar', 'Tatarça', '0'),
  ('tw', 'Twi', 'Twi', '0'),
  ('ty', 'Tahitian', 'Reo Mā`ohi', '0'),
  ('ug', 'Uyghur', 'Uyƣurqə / ئۇيغۇرچە', '0'),
